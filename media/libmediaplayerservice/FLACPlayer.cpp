...
// not handled now, only dummy implementation
status_t FLACPlayer::setDataSource(const char *url, const KeyedVector<String8, String8> *headers) {
    LOGV("FLACPlayer setDataSource('%s')", url);
